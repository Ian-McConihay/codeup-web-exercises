...
// alert('Hey, it is ' + haveToy + ' that you can habe the toy');
...
// A do/while loop is quite similar to a while loop.
// The biggest difference is that a do/while loop will run at least once
// [do this thing for sure this first time . . then check condition to continue VS.
// check condition . . will I do this thing at all?]
...
// // FOR LOOP: Loops that are designed to run a given number of times. Think more math thinking.
//
...
// We can get a loop to stop using break; and to continue by using continue
...
//     x++;
//     //the top half would go on forever
//     if (x === 5) {
